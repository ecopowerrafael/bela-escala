...
export default function WelcomePage() {
  return (
    <div className="min-h-screen bg-[#050505] font-sans flex flex-col items-center justify-center p-0 sm:p-4 overflow-x-hidden">
      ...
      {/* Background Gradient */}
      <div className="fixed inset-0 bg-gradient-to-b from-[#0e0e0e] to-[#000000] -z-10"></div>
